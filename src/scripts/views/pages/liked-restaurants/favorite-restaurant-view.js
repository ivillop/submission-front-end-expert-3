 ...
 <path fill="#000" d="M25.251,6.461c-10.318,0-18.683,8.365-18.683,18.683h4.068c0-8.071,6.543-14.615,14.615-14.615V6.461z">
  ...
  showFavoriteRestaurants(restaurants) {
    ...
    if (restaurants.length) {
      html = restaurants.reduce((carry, restaurant) => carry.concat(listRestaurantCard(restaurant)), '');
    } else {
      html = this._getEmptyRestaurantTemplate();
    }

    document.getElementById('data-kuliner').innerHTML = html;

    document.getElementById('data-kuliner').dispatchEvent(new Event('data-kuliner:updated'));
  }
